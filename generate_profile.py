...
INFO = [
    ...
    ("Focus",    "Full Stack Engineering  ·  Agentic AI / LLMs", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",     "Python · Java · JavaScript · C# · SQL", "val"),
    ("Frontend",     "Next.js · Angular", "val"),
    ...
    ("ChaChaLens", "VLM driven speech assistant for visually disabled on Hololens 2", "warn"),
     ("__blank__", "", ""),
    ("__section__", "~/highlights", ""),
    ("Award",    "Home4Strays as 2nd best project at University of Applied Sciences in Augsburg", "val"),
    ("__stats__", "", ""),
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Web",      "https://github.com/meryem9907", "accent"),
    ("Portfolio",   "https://about-me-with-ai-chatbot.onrender.com/", "accent"),
    ("In",       "https://www.linkedin.com/in/meryem-%C3%BCn%C3%BCvar-cs/?locale=en", "accent"),
    ("Mail",     "meryem9907@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to Full Stack Engineer / AI Engineer roles as an Intern or Junior Developer</tspan>'
